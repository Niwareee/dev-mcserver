package fr.niware.serverapi.paper.utils.builder;
...
public class ItemBuilder implements Cloneable {
    ...
    public ItemBuilder setGlowing() {
        this.addEnchant(this.material != Material.BOW ? Enchantment.ARROW_INFINITE : Enchantment.LUCK, 1).addFlag(ItemFlag.HIDE_ENCHANTS);
        return this;
    }
    ...
    public ItemStack build() {
        ...
        if (this.durability != 0 && this.item instanceof Damageable damageable) {
